...
[![Tests](https://img.shields.io/badge/tests-812%20passed-brightgreen.svg)](#-measured-results)
...
| [📊 Measured results](#-measured-results) | 812 tests · 187/187 scenarios · 113 mutants defined |
...
Test suite: **812 passed** (`make test`) across unit, security and integration, in
...
807 passed and 5 skipped. They are the cross-replica tests, and a fake that agrees
...
tests/          unit · security · integration  (812 tests)
