...
# Re-pointed when feat/incident-spine merged into integration/trunk. Both this
# migration and trunk's 351d7cd7c50d were written as children of d09395a87106,
# so the merge left the graph with two heads and `alembic upgrade head` refused
# to run. Nothing about this migration's CONTENT changed -- it just follows the
# identity work rather than racing it.
down_revision = '075d7e974f92'
branch_labels = None
depends_on = None
