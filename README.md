...
[![Tests](https://img.shields.io/badge/tests-1123%20passed-brightgreen.svg)](#-measured-results)
...
| [📊 Measured results](#-measured-results) | 1123 tests · 187/187 scenarios · 139 mutants defined |
...
```bash
make web-test                     # 341 Vitest tests
...
22. **Six advisories in the build and test tooling were closed by upgrading it,
    ...
    and all 15 browser journeys and accessibility scans against `vite preview`,
...
ui/             Streamlit app
web/            React SPA — Vite + TypeScript (ADR-0015), 341 tests
...
tests/          unit · security · integration  (1123 tests)
